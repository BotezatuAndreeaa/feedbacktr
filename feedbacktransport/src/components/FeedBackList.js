      ...
      <div className="datatable-crud-demo">
        ...
        <div className="card">
          <DataTable
            ...
            currentPageReportTemplate="Afiseaza {first} pana la {last} din {totalRecords} feedback-uri"
          ...
          >
            ...
            ></Column>
            <Column field="tipTransport" header="Mijloc transport"></Column>
            <Column
              field="oraPlecare"
              header="Ora de plecare"
              sortable
              style={{ minWidth: "8rem" }}
            ></Column>
            <Column
        ...
        >
          <div className="p-field">
            <label htmlFor="plecare">Plecare din</label>
            <InputText
              id="plecare"
            ...
            {submitted && !feedback.plecare && (
              <small className="p-error">introduceti punctul de plecare!</small>
            )}
          </div>
          <div className="p-field">
            <label htmlFor="sosire">Destinatia</label>
            <InputText
              id="sosire"
            ...
            {submitted && !feedback.sosire && (
              <small className="p-error">introduceti punctul de sosire!</small>
            )}
          </div>
          <div className="p-field">
            <label className="p-mb-3">Mijloc transport</label>
            <div className="p-formgrid p-grid">
              ...
              <div className="p-field-radiobutton p-col-6">
                ...
                />
                <label htmlFor="troleu">Metrou</label>
              </div>
            </div>
          </div>
          <div className="p-field">
            <label htmlFor="oraPlecare">Ora plecarii:</label>
            <InputText
              id="oraPlecare"
            ...
            {submitted && !feedback.oraPlecare && (
              <small className="p-error">introduceti ora plecarii!</small>
            )}
          </div>
          <div className="p-field">
          ...
          <div className="p-field">
            <label htmlFor="nivelAglomerare">Nivel Aglomerare</label>
            <InputText
              id="nivelAglomerare"
            ...
            {submitted && !feedback.nivelAglomerare && (
              <small className="p-error">introduceti nivelul de aglomerare de la 1 la 10!</small>
            )}
          </div>
          ...
          <div className="p-field">
            ...
            {submitted && !feedback.gradSatisfactie && (
              <small className="p-error">introduceti gradul de satisfactie de la 1 la 10;</small>
            )}
          </div>
        </Dialog>
      </div>
